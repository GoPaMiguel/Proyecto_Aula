...
import Principal.AlmacenarResiduos;
import Principal.Residuos;
...
public class Principal extends javax.swing.JFrame {
    ...
    DefaultTableModel modelo1 = (DefaultTableModel) tbModificar.getModel();
    modelo1.setRowCount(0); 
    ...
    DefaultTableModel modelo2 = (DefaultTableModel) tbEliminar.getModel();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 405));
        ...
        pnRegistrarLayout.setVerticalGroup(
            ...
            .addGroup(pnRegistrarLayout.createSequentialGroup()
                ...
                .addGroup(pnRegistrarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel9, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 301, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1.add(pnCambiante, new org.netbeans.lib.awtextra.AbsoluteConstraints(194, -41, -1, 440));
    ...
    private void eliminarFilaSeleccionada() {
        ...
        if (filaSeleccionada != -1) {
            ...
            if (confirmacion == JOptionPane.YES_OPTION) {
                ...
                Object valorCodigo = tbEliminar.getValueAt(filaSeleccionada, 0);
                String CodigoEncontrado = valorCodigo.toString();
    ...
    private void modificarFila(){
        ...
        if (filaSeleccionada != -1) {
            ...
            almacenamiento.modificarResiduo(ResiduoActual, codigoActual,materialModificado, objetoModificado, puntosModificado);
            }
         else {
            JOptionPane.showMessageDialog(null, "No se ha seleccionado ninguna fila");
        }
